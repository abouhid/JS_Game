...
export default class CreditsScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.text3 = this.add.text(60, this.game.config.height / 2 - 50,
    ...
    this.text3 = this.add.text(60, this.game.config.height / 2,
